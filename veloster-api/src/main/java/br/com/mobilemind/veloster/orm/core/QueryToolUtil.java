...
public class QueryToolUtil {
    ...
    public static void setConverterDataBaseErroCodeListener(ConverterDataBaseErroCodeListener converter){
        QueryToolUtil.converter = converter;
    }
    
    public static void removeConverterDataBaseErroCodeListener(){
        QueryToolUtil.converter = null;
    }
    
    public static ConverterDataBaseErroCodeListener getConverterDataBaseErroCodeListener(){
        return QueryToolUtil.converter;
    }
}
